<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="company_slug" value="{{ __('Company Slug') }}" />
                <x-input id="company_slug" class="block mt-1 w-full" type="text" name="company_slug" :value="old('company_slug')" required autocomplete="company_slug" />
            </div>
